...
namespace Events.Login
{
    public class EventLoginReq : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventLoginReq))
            {
                flag = false;
            }
            return length;
    ...
    public class EventLoginResp : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventLoginResp))
            {
                flag = false;
            }
            return length;
    ...
    public class EventLogout : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventLogout))
            {
                flag = false;
            }
            return length;
    ...
    public class EventMasterLoginReq : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventMasterLoginReq))
            {
                flag = false;
            }
            return length;
    ...
    public class EventMasterLoginResp : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventMasterLoginResp))
            {
                flag = false;
            }
            return length;
    ...
    public class EventMasterLogout : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventMasterLogout))
            {
                flag = false;
            }
            return length;

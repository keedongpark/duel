...
namespace Events.Timer
{
    public class EventTimerBase : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventTimerBase))
            {
                flag = false;
            }
            return length;
    ...
    public class TimerMatch : EventTimerBase
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            int length = base.GetLength(targetType, ref flag);
            if (!flag) { return length; }
            if (targetType != null && targetType == typeof(TimerMatch))
            {
                flag = false;
            }
            return length;
    ...
    public class TimerCoordinator : EventTimerBase
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            int length = base.GetLength(targetType, ref flag);
            if (!flag) { return length; }
            if (targetType != null && targetType == typeof(TimerCoordinator))
            {
                flag = false;
            }
            return length;

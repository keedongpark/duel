...
namespace Events.Cluster
{
    ...
    public class ServerStatus : Cell
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(ServerStatus))
            {
                flag = false;
            }
            return length;
    ...
    public class EventServerList : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventServerList))
            {
                flag = false;
            }
            return length;
    ...
    public class EventJoin : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventJoin))
            {
                flag = false;
            }
            return length;
    ...
    public class EventLeave : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventLeave))
            {
                flag = false;
            }
            return length;

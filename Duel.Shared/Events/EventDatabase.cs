...
namespace Events.Database
{
    public class EventCreateOrLoadUserReq : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventCreateOrLoadUserReq))
            {
                flag = false;
            }
            return length;
    ...
    public class EventLoadUserReq : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventLoadUserReq))
            {
                flag = false;
            }
            return length;
    ...
    public class EventLoadUserResp : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventLoadUserResp))
            {
                flag = false;
            }
            return length;
    ...
    public class EventUpdateUserReq : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventUpdateUserReq))
            {
                flag = false;
            }
            return length;
    ...
    public class EventUpdateUserResp : Event
    {
        ...
        public override int GetLength(Type targetType, ref bool flag)
        {
            ...
            if (targetType != null && targetType == typeof(EventUpdateUserResp))
            {
                flag = false;
            }
            return length;
